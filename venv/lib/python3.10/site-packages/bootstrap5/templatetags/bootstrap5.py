...
def bootstrap_label(*args, **kwargs):
    ...
    **Example**::
        ...
        {% bootstrap_label "Email" label_for="exampleInputEmail1" %}
    """
...
def bootstrap_messages(context, *args, **kwargs):
    ...
    **Example**::
    ...
    return render_template_file("bootstrap5/messages.html", context=context)


@register.inclusion_tag("bootstrap5/pagination.html")
